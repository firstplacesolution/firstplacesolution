const {transactionDetailsByInvestorId} = require('../helpers/transaction.helper');
...
async function updateTransaction(req,res) {
    try {
        ...
        if (!errors.isEmpty()) {
            ...
            const transactionStatusUpdate = await transactionModel.findByIdAndUpdate(id, {transaction_status});
